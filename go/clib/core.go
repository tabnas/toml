...
//
// libtabnastoml is the toml format parser as a C shared library, one of
...
import (
	...
	plug "github.com/tabnas/toml/go"
)

const (
	templateVersion = "v1"
	libName         = "libtabnastoml"
	formatName      = "toml"
	valueOut        = true
)
...
// newParser builds one engine with the toml grammar installed
...
// parseWith answers whether src is in the toml language — and,
